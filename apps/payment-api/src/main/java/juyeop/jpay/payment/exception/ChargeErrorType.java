...
public enum ChargeErrorType implements ErrorType {
	IDEMPOTENCY_CONFLICT("idempotency-conflict", "Idempotency Conflict", HttpStatus.CONFLICT), UPSTREAM_UNAVAILABLE("upstream-unavailable", "Bank Transfer Unavailable", HttpStatus.SERVICE_UNAVAILABLE);
